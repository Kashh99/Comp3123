...
- Why is `express.Router()` used in Express.js applications, and how does it benefit the code structure?
 ...
 => It is a feature in Express.js that allows you to create modular, mountable route handlers. It helps in organizing and structuring the routing logic by separating routes into smaller sections based on functionality, which can then be used in the main app file.
...
=> To handle errors in Express.js, you can use middleware functions designed specifically for error handling. The error-handling middleware should be placed after all routes and middleware.
